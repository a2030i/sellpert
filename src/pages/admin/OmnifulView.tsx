    ...
    <div style={{ ...S.tableCard, padding: 18, marginBottom: 16 }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 11 }}>
          ...
          <div>
            <strong style={{ display: 'block', fontSize: 15 }}>توزيع قنوات البيع على التجار</strong>
            <span style={{ display: 'block', marginTop: 4, color: 'var(--text3)', fontSize: 11, lineHeight: 1.7 }}>افحص الحساب المركزي، ثم اختر قناة أو عدة قنوات واربطها بالتاجر. لا يمكن تعيين القناة نفسها لمتجرين.</span>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', gap: 7, alignItems: 'flex-start', marginTop: 14, padding: '10px 12px', borderRadius: 9, background: 'var(--success-bg)', color: 'var(--success-text)', fontSize: 10, lineHeight: 1.7 }}>
        ...
        <span>كل تاجر جديد يبدأ بالربط المركزي ولا يرى Omniful. إذا طلب حسابًا خاصًا، غيّر نوع الربط هنا فقط؛ بعدها تظهر له شاشة إدخال حسابه واستدعاء قنواته.</span>
      </div>
    </div>
