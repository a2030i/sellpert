...
insert into auth.users (
  ...
  ('00000000-0000-4000-8000-000000008801', 'authenticated', 'authenticated', 'atomic-a@test.invalid', '',
   '{"provider":"email","providers":["email"]}', '{"signup_source":"self_service","name":"Atomic A"}', now(), now(), now(), false, false),
  ('00000000-0000-4000-8000-000000008802', 'authenticated', 'authenticated', 'atomic-b@test.invalid', '',
   '{"provider":"email","providers":["email"]}', '{"signup_source":"self_service","name":"Atomic B"}', now(), now(), now(), false, false);
