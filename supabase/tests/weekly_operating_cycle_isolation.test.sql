...
insert into auth.users (
  ...
  ('00000000-0000-4000-8000-000000009990', 'authenticated', 'authenticated', 'cycle-a@test.invalid', '',
   '{"provider":"email","providers":["email"]}', '{"signup_source":"self_service","name":"Cycle A"}', now(), now(), false, false),
  ('00000000-0000-4000-8000-000000009991', 'authenticated', 'authenticated', 'cycle-b@test.invalid', '',
   '{"provider":"email","providers":["email"]}', '{"signup_source":"self_service","name":"Cycle B"}', now(), now(), false, false);
