...
insert into auth.users (
  ...
  ('00000000-0000-4000-8000-000000009987', 'authenticated', 'authenticated', 'brief-a@test.invalid', '',
   '{"provider":"email","providers":["email"]}', '{"signup_source":"self_service","name":"Brief A"}', now(), now(), now(), false, false),
  ('00000000-0000-4000-8000-000000009988', 'authenticated', 'authenticated', 'brief-b@test.invalid', '',
   '{"provider":"email","providers":["email"]}', '{"signup_source":"self_service","name":"Brief B"}', now(), now(), now(), false, false);
