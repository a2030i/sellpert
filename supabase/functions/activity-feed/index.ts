...
Deno.serve(async req => {
  ...
  try {
    ...
    if (action && !['insert', 'update', 'delete', 'account_closure_requested', 'account_closure_cancelled', 'account_closure_completed'].includes(action)) throw new HttpError(400, 'مرشح الإجراء غير صالح.')
