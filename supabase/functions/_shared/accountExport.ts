...
export const ACCOUNT_EXPORT_RESOURCES: readonly AccountExportResource[] = [
  ...
  { key: 'invoices', label: 'الفواتير', table: 'invoices' },
  { key: 'payouts', label: 'جدول التحويلات', table: 'merchant_payout_schedule' },
  { key: 'payment_requests', label: 'طلبات الدفع', table: 'payment_requests' },
  { key: 'subscriptions', label: 'سجل الاشتراك', table: 'subscriptions' },
  ...
  { key: 'insights', label: 'الرؤى والتحليلات', table: 'ai_insights' },
  ...
  { key: 'platform_mappings', label: 'ربط المنصات', table: 'merchant_platform_mappings' },
